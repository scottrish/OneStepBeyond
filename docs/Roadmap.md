...
**Status: in progress. Steps 1 (2026-09-24), 2, 9 and 10 (2026-09-25) done, taken out of order at product-owner direction; step 3 analyzed, decisions made 2026-09-25, not yet built; the rest proposed.**
...
| 4 | Separate Saturday / Sunday study hours | [study-hours-v2-proposal.md](features/study-hours-v2-proposal.md) | ✅ Decided 2026-09-25: retire `PROTECTED_MINUTES` (§3, option b) | **Schema migration**: tag, and run `schema-migration-reviewer`. Must land before Phase C |
