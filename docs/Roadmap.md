...
| # | Step | Spec |
|---|---|---|
| 13 | PWA phase 2: service worker, offline, background sync, push | **Spec approved 2026-09-25:** [pwa-phase-2-offline-v0.1.md](features/pwa-phase-2-offline-v0.1.md) (`docs/decisions/20260925-pwa-phase-2-approach.md`). Three increments, each its own analyze → implement cycle: ✅ **2a** app shell offline + updates (done 2026-09-25), **2b** last-known plan (next), **2c** offline session actions. Push notifications deferred (backlog) |
